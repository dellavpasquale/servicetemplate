...
public class UpdatePurchaseOrderUseCase {
	...
	public PurchaseOrder update(PurchaseOrderEditRequest purchaseOrderEditRequest) throws InvalidOperationException, DomainEntityNotFoundException, InvalidDomainEntityException, ForbiddenOperationException, ServiceUnavailableException {
