...
public class UseCaseConfiguration {
	...
	@Bean 
	public CreatePurchaseOrderUseCase getCreatePurchaseOrderUseCase(PurchaseOrderPersistenceService purchaseOrderPersistenceService, PurchaseOrderNotificationService purchaseOrderNotificationService, AccessControlService accessControlService) {
